...
export function SummaryPanel({ meetingId, summary, actionItems: initialActionItems }: SummaryPanelProps) {
    ...
    return (
        <div className="flex flex-col h-full bg-background rounded-xl border">
            <Tabs defaultValue="summary" className="flex-1 flex flex-col h-full">
                ...
                <ScrollArea className="flex-1 p-4">
                    ...
                    <TabsContent value="action_items" className="m-0 space-y-4 flex flex-col h-[calc(100vh-28rem)]">
                    ...
                    <TabsContent value="chat" className="m-0 flex flex-col h-[calc(100vh-28rem)]">
